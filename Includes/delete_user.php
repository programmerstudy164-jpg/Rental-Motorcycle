...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['user_id']) && !empty($_POST['user_id'])) {
        ...
        if ($count > 0) {
            ...
            if ($stmt->execute()) {
                echo "<script>alert('User deleted successfully.'); window.location.href='../reg_user.php';</script>";
            } else {
            ...
            echo "<script>alert('User not found or invalid ID.'); window.location.href='../reg_user.php';</script>";
        }
    } else {
