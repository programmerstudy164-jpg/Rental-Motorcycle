...
<li class="menu-item ">
            ...
            <div class="col-md-10 col-sm-9">
                ...
                <div class="card-header" style="background:linear-gradient(130deg,rgba(34, 193, 195, 1) 0%, rgba(253, 187, 45, 1) 100%);">
                    ...
                    <div class="card-body ">
                        ...
                        <form method="POST" action="Includes/add_staff.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="floating-label">
                                        <input type="tel" name="username" class="form-control" id="Name" placeholder=" ">
                                ...
                                <div class="col-md-6">
                                    <div class="floating-label">
                                        <input type="tel" name="phoneNum"  class="form-control" id="EmailAddress" placeholder=" " >
  ...
  <div class="custom-file">
    <input type="file" name="profile_image" class="custom-file-input" id="vehicleImage">
    <label class="custom-file-label" for="vehicleImage" style="width: auto;">Choose Profile image...</label>

  </div>
</div>
                                <div class="col-md-6">
                                    <div class="floating-label">
                                        <input type="email" name="email" class="form-control" id="Name" placeholder=" ">
  ...
  <div class="col-md-9">
    <div class="floating-label position-relative">
      ...
      <i class="fas fa-eye-slash toggle-password"
         ...
         style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; z-index: 5;">
      </i>
    </div>
  </div>
</div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
  ...
  <script>
    ...
    var fileName = this.files[0] ? this.files[0].name : "Choose Profile image...";
