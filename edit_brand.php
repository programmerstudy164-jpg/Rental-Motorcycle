...
if (isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM brand WHERE brand_id = $id");
        ...
        <div class="row justify-content-center">
            <div class=" col-md-10">
                <div class="registration-card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="Includes/edit_data_brand.php">
                            <div class="section-title" >
                                <i class="fas fa-info-circle mr-2"></i> Brand Motorcycle
                            </div>
                            
                            <div class="form-group floating-label-group">
                                 <input type="hidden" name="brand_id" value="<?= $row['brand_id'] ?>">
                                <input type="text" name="Brand" class="form-control" id="vehicleTitle" placeholder=" " required value="<?= htmlspecialchars($brand) ?>">
                                <label class="floating-label" for="vehicleTitle">Brand</label>
                            </div>
