...
if (isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM motorcycle WHERE id_moto = $id");

    if ($row = $result->fetch_assoc()) {
      
        $vehicle = $row['Vehicle'];
        $Day = $row['Price_Per_Day'];
...
$moto = $conn->query("SELECT * FROM motorcycle WHERE id_moto = $id")->fetch_assoc();
      ...
      <li class="nav-item dropdown list-unstyled">
        <a class="nav-link profile-pic" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <div class="profile-wrapper">
            <img src="https://i.pinimg.com/originals/96/10/c3/9610c30481c6916a584952b7d2cf5912.jpg" alt="Profile" class="avatar-sm">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
          <div class="dropdown-user-scroll scrollbar-outer">
            <div class="user-box text-center p-3">
              <img src="https://i.pinimg.com/originals/96/10/c3/9610c30481c6916a584952b7d2cf5912.jpg" alt="Profile" class="avatar-lg mb-3">
              <div class="u-text">
  ...
  <!-- Main Content -->
   <div class="main-content">
        ...
        <div class="row justify-content-center">
            <div class=" col-md-12">
                <div class="registration-card" >
                    ...
                    <div class="card-body">
                        <form method="POST" action="Includes/edit_data_vehicle.php" enctype="multipart/form-data">
                            <div class="section-title" >
                                <i class="fas fa-info-circle mr-2"></i> Vehicle Details
                            </div>
                            
                            <div class="form-group floating-label-group">
                                 <input type="hidden" name="id_moto" value="<?= $row['id_moto'] ?>">
                                <input type="text" name="vehicle_title" class="form-control" id="vehicleTitle" placeholder=" " required value="<?= htmlspecialchars($vehicle) ?>">
                         ...
                         <option value="<?= $b['brand_id'] ?>" <?= $b['brand_id'] == $moto['brand_id'] ? 'selected' : '' ?>>
                <?= $b['Vehicle_brand'] ?>
                                          <?php endwhile; ?> 
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group floating-label-group">
                                        <input type="number" name="price_per_day" class="form-control" id="pricePerDay" placeholder=" " step="0.01" min="0" required value="<?= htmlspecialchars($Day) ?>">
    ...
    <option value="Manual" <?php echo ($transmission == 'Manual') ? 'selected' : ''; ?>>Manual</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group floating-label-group">
                                        <input type="number" name="model_year" class="form-control" id="modelYear" placeholder=" " min="1900" max="2099" required value="<?= htmlspecialchars($year) ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group floating-label-group">
                                        <input type="text" name="displacement" class="form-control" id="displacement" placeholder=" " required value="<?= htmlspecialchars($displacement) ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-file">
                                        <input type="file" name="vehicle_image" class="custom-file-input" id="vehicleImage" accept="image/*" value="<?= htmlspecialchars($image) ?>">
