        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-9">
                ...
                <div class="card registration-card ">
                    ...
                    <form method="POST" action="Includes/edit_profile_admin_staff.php" enctype="multipart/form-data">
...
<input type="hidden" name="role" value="<?php echo $_SESSION['role']; ?>">
                           ...
                           <div class="row">
                                 ...
                                 <div class="col-md-6">
                                   <div class="floating-label">
                                       <input type="tel" name="username" class="form-control" id="Name" placeholder=" "value="<?php echo htmlspecialchars($username); ?>">
                               ...
                               <div class="col-md-6">
                                   <div class="floating-label">
                                       <input type="tel" name="phoneNum"  class="form-control" id="EmailAddress" placeholder=" " value="<?php echo htmlspecialchars($phoneNum); ?>">
