        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-9">
                ...
                <div class="card registration-card ">
                    ...
                    <form method="POST" action="Includes/update_password_staff_admin.php" enctype="multipart/form-data">
    <h5 class="section-title " style="color: #3b5d50;">Update Password</h5>

    <div class="row justify-content-center" >
        <div class="col-md-9 mt-4">
            <div class="floating-label" style="position: relative;">
                <input type="password" name="curpass" class="form-control" id="FirstName" placeholder=" " required>
                <label for="FirstName">Current Password</label>
                <i class="fas fa-eye-slash toggle-password" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer;" onclick="togglePassword('FirstName', this)"></i>
            </div>
        </div>
        
        <div class="col-md-9">
            <div class="floating-label" style="position: relative;">
                <input type="password" name="newpass" class="form-control" id="lastName" placeholder=" " required>
                <label for="lastName">New Password</label>
                <i class="fas fa-eye-slash toggle-password" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer;" onclick="togglePassword('lastName', this)"></i>
            </div>
        </div>

        <div class="col-md-9">
            <div class="floating-label" style="position: relative;">
                <input type="password" name="enter" class="form-control" id="lastName" placeholder=" " required>
