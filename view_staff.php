  ...
  <div class="table-container">
    <div class="table-title" style="background: linear-gradient(130deg, rgba(34, 193, 195, 1) 0%, rgba(253, 187, 45, 1) 100%); border-radius: 8px 8px 0 0;">
      <div class="d-flex justify-content-between align-items-center">
        <h2 class="mb-0 text-white"><i class="fas fa-users me-2"></i>Manage Staff</h2>
...
$where = "WHERE role = 'staff'"; // Use 'role' instead of 'usertype'
...
<div class="table-responsive">
  <table class="table table-striped table-hover align-middle" id="customerTable">
    ...
    <!-- Edit Button -->
    <a href="edit_staff.php?user_id=<?= $row['user_id']; ?>" class="text-primary d-inline-flex align-items-center" data-toggle="tooltip" title="Edit">
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <form method="POST" action="Includes/delete_staff.php">
